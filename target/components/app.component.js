System.register(['@angular/core', '@angular/router-deprecated', './login.component', './game.component'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_deprecated_1, login_component_1, game_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
